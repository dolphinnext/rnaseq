...
RUN mkdir /tmp/dolphin-tools && cd /tmp/dolphin-tools
RUN git clone https://github.com/onuryukselen/tools /tmp/dolphin-tools
RUN ln -s /tmp/dolphin-tools /usr/local/bin/dolphin-tools
